...
parser=argparse.ArgumentParser(description='''The script is Fastq files by specified ranges of GC-content in reads. Reads that don't match any specified range will be moved to the "unassigned.fastq" file.''')
